...
function setupStartScreen() {
    ...
    populateUnlocks(playerProgress, (type, id) => {
        ...
        setupStartScreen(); // refresh showcase to reflect new selection
    });
    // showcase models
    if (showcaseBear) scene.remove(showcaseBear);
    ...
    if (showcaseFish) scene.remove(showcaseFish);
